...
use App\Repository\EmplacementsMaterielsRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=EmplacementsMaterielsRepository::class)
 */
class EmplacementsMateriels
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Materiels::class, mappedBy="emplacement")
     */
    private $materiels;
